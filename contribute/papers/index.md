...
Papers will not have the option to be automatically accepted as IEEE VR Posters. Rather, authors of rejected papers will have to submit directly to the poster track.

All senior (PhD-holding) authors should familiarize themselves with the IEEE VR 2027 reviewing guidelines. Unless serving IEEE VR 2027 in another capacity, ALL SENIOR AUTHORS are expected to volunteer as reviewers and perform their duties in a timely and responsive fashion. This supersedes the prior requirement that one author for each paper commit to reviewing; if a paper has multiple senior co-authors, all are expected to volunteer. Egregious violations of this policy may be considered Highly Irresponsible Conduct, which could result in penalties up to and including desk rejection of their submitted paper(s).

Submissions will be accepted through TBD (submission platform details to be announced).

## Important Dates

All deadlines are at 23:59:59 AoE (Anywhere on Earth, UTC−12:00).

| Milestone | Date |
| :--- | :--- |
| Abstracts due *(required)* | **August 24, 2026** |
| Submissions due | **August 31, 2026** |
| Initial notifications | TBD |
| Revised submissions due | TBD |
| Final notifications | TBD |
| Camera-ready materials due | TBD |
...
**IMPORTANT:** IEEE VR 2027 uses a **DOUBLE-BLIND** review process. Failure to anonymize submissions will result in **DESK REJECTION.** Authors should review the Author Guidelines at TBD.
</div>
...
**Format:** Papers must be strictly formatted according to IEEE VGTC **conference** submission guidelines and submitted electronically as PDF documents.

* All paper submissions must be formatted using the IEEE Computer Society VGTC conference format (TBD). See the visual examples below.
...
* Papers should be 4–9 pages of text, figures, and tables, but NOT including references. References should not exceed 2 pages in length. Note that the minimum length is 4 full pages of text. Appendices are included in the page count.
...
The increasing number of submissions for IEEE VR makes us all dependent on a large number of good reviewers who are willing to provide constructive feedback and engage with authors on their work. Every paper needs three quality reviews. To expand the reviewing pool and to promote quality reviews, for each submitted paper, each senior author will be required to register to review at least one paper through the submission system at the time of submission — although more would obviously be welcome. Additionally, senior authors are encouraged to ask experienced junior authors to register to review papers, and then to mentor the experienced junior authors during the review process.
